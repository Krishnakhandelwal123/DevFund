...
import {
  ...
  MoreHorizontal, LogOut, Edit, DollarSign, Users, Crown, TrendingUp,
  Calendar, BarChart3, Target, Award, User, Shield, Palette, Bell as BellIcon,
  ArrowRight, Heart
} from 'lucide-react';
import { useAuthStore } from '../Store/AuthStore';
import { useCreatorStore } from '../Store/CreatorStore';
import CreatorPosts from './creatorDashboard/Posts';
import CreatorAnalytics from './creatorDashboard/Analytics';
import CreatorSupporters from './creatorDashboard/Supporters';
import CreatorSettings from './creatorDashboard/Settings';
...
const CreatorDashboardHome = () => {
  const navigate = useNavigate();
  const { authUser } = useAuthStore();
  const { creatorStats, fetchCreatorStats } = useCreatorStore();
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-white">{creatorStats?.supportersCount ?? 0}</p>
              </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-white">${creatorStats?.totalEarnings ?? 0}</p>
              </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="text-neutral-400 text-sm">Posts Shared</p>
                <p className="text-2xl font-bold text-white">{creatorStats?.totalPostsShared ?? 0}</p>
              </div>
...
const CreatorHome = () => {
  ...
  const navItems = [
    ...
    { name: 'Posts', icon: <Target size={22} />, path: '/c/posts' },
  ...
  return (
    <div className='relative h-screen overflow-hidden bg-gradient-to-b from-neutral-950 via-neutral-900 to-neutral-950'>
      ...
      <motion.div
        className='relative z-10 text-white gap-8 flex h-screen p-8 overflow-y-auto'
      ...
      >
        {/* Left Sidebar Panel */}
        <motion.div
          className='w-[22%] rounded-3xl border border-white/10 bg-black/20 backdrop-blur-xl shadow-2xl flex flex-col h-full overflow-y-auto'
