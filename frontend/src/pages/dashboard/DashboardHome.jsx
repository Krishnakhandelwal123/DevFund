...
const DashboardHome = () => {
  ...
  const { supporterProfile, fetchProfile } = useSupporterStore();
  ...
  const stats = {
    totalFunded: supporterProfile?.totalAmountFunded ?? 0,
    projectsSupported: supporterProfile?.projectsSupported ?? 0,
    creatorsBacked: supporterProfile?.numberOfCreatorsFunded ?? 0,
    ...
    switch (type) {
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-neutral-800 rounded-xl p-6 border border-neutral-700 hover:border-neutral-600 transition-colors">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-neutral-400 text-sm">Creators Funded</p>
