  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path='/c/posts' element={<CreatorRoute><CreatorHome /></CreatorRoute>} />
        <Route path='/c/posts/new' element={<CreatorRoute><CreatePost /></CreatorRoute>} />
        ...
        {/* Public creator profile (for authenticated users) */}
